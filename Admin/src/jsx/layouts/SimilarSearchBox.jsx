...
const SimilarSearchBox = ({ onClick, toggle }) => {
    console.log("onClick, toggle in SimilarSearchBox-=-=-=-=-=-=-=->",onClick, toggle)
   ...
   return (
      <div className={`chatbox ${toggle === "similarSearchItemBox" ? "active" : ""}`}>
...
export default SimilarSearchBox;
