...
import NewsList from "../pages/newsManagement/NewsList";
...
const Markup = () => {
  const allroutes = [
    ...
    { url: "edit-employee/:id", component: <EditEmployee /> },
    ...
    // News
    { url: "add-news", component: <AddNews /> },
    { url: "news-list", component: <NewsList /> },
    { url: "edit-news/:id", component: <EditNews /> },
  ];
